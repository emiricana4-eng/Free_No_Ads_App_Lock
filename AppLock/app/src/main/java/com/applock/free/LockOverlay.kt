...
class LockOverlay(
                    ...
                    if (
                        ...
                        val target =
                            if (recoveryMode)
                                ...
                                prefManager.pinLength

                        if (
                            target > 0 &&
                            enteredPin.length >= target
                        ) {

                            if (recoveryMode) {

                                checkRecovery(tvDots)
    ...
    private fun checkPin(
        ...
        if (
            ...
            toast(
                if (wrongAttempts >= 3)
                    "Wrong PIN — $wrongAttempts attempts"
                else
                    "Wrong PIN"
            )
        }
    ...
    private fun checkRecovery(
        ...
        if (
            ...
            toast(
                "Recovery successful! Please set a new PIN."
            )
    ...
    private fun grantAccess(
        ...
        LockService.tempUnlocked.add(pkg)
